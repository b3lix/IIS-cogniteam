<template>
  <b-container>
    <b-nav pills>
      ...
      <b-nav-item disabled active>Úprava spoju</b-nav-item>
    </b-nav>
    <hr>
    <b-alert variant="warning" show>
      <font-awesome-icon icon="info"></font-awesome-icon>
      V prípade zmeny sa zneplatnia doposiaľ vytvorené rezervácie na tento spoj!
    </b-alert>
    <hr>
    ...
    <b-form method="POST" @submit.prevent="update">
      ...
      <b-form-group>
        ...
        <b-button variant="danger" type="button" @click="deleteRoute(id)">Zmazať spoj</b-button>
      </b-form-group>
    </b-form>
  </b-container>
</template>
...
export default {
  ...
  methods: {
    update() {
      if(!confirm("Naozaj chcete upraviť tento spoj?"))
        return;
